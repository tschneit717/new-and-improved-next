...
export async function getStaticProps({ req, res }): Promise<{ props: { title: string, mobileTitle: string, tagline: string, content: string, companies: any[], image: SanityImageObject, accent: string, footer: unknown } }> {
